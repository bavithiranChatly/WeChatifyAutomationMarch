Feature: Verfiy Rich media jump link creativce feature for positive scenario
 ...
 @check
  ...
  Scenario Outline: TC-8689 Rich media card - "Notify to User" check for "Approve & Send to Library" - Rich Media Card
      1. Create RTM JumpLink creative
      2. Valid JPEG File
      3. With Use of Save and Save & Close
      4. Validate all the available navigation on different Pages
  ...
  Scenario Outline: TC-8689 Rich media card - "Notify to User" on Draft page - Rich Media Card
      1. Create RTM JumpLink creative
      2. Valid JPEG File
      3. With Use of Save and Save & Close
      4. Validate all the available navigation on different Pages
  ...
  Scenario Outline: TC-8689 Rich media card - "Notify to User" on Translation page - Rich Media Card
      1. Create RTM JumpLink creative
      2. Valid JPEG File
      3. With Use of Save and Save & Close
      4. Validate all the available navigation on different Pages
  ...
  Scenario Outline: TC-8689 Rich media card - "Notify to User" on Translation Review page - Rich Media Card
    1. Create RTM JumpLink creative
    2. Valid JPEG File
    3. With Use of Save and Save & Close
    4. Validate all the available navigation on different Pages
  ...
  Scenario Outline: TC-8689 Rich media card - "Notify to User" on Approve page - Rich Media Card
      1. Create RTM JumpLink creative
      2. Valid JPEG File
      3. With Use of Save and Save & Close
      4. Validate all the available navigation on different Pages
  ...
  @check
  Scenario Outline: TC-8689 Rich media card - "Notify to User" on Draft review page - Rich Media Card
      1. Create RTM JumpLink creative
      2. Valid JPEG File
      3. With Use of Save and Save & Close
      4. Validate all the available navigation on different Pages
